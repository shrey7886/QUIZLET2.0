...
#     created_at = Column(DateTime(timezone=True), server_default=func.now())
#     
#     # Relationships - temporarily disabled to fix database issues
#     # user = relationship("User", foreign_keys=[user_id], back_populates="topic_suggestions")
...
class StudyGroup(Base):
    ...
    # chat_room = relationship("ChatRoom", uselist=False)  # Temporarily disabled - missing foreign key
